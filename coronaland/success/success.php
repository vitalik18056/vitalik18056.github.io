...
<?php if (!empty($_GET['id'])): ?>
  ...
  <script>
      ...
      fbq('init', '<?php echo htmlspecialchars($_GET['id']); ?>');
      fbq('track', 'Lead');
      fbq("track", "PageView");
  </script>

  <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=<?php echo htmlspecialchars($_GET['id']); ?>&ev=Lead&noscript=1"/></noscript>
